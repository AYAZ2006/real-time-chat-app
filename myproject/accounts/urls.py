...
from .views import (RegisterView, LoginView,get_csrf_token,SearchUsersView,Send,View,AcceptRejectFriendRequestView,ListFriends,LoggedInUserView)
...
urlpatterns = [
    ...
    path('logged-in-user/', LoggedInUserView.as_view(), name='logged-in-user'),
]
